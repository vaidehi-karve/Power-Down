  ...
  const outcomes = {
    bill: {
      tou: () => {
        ...
        return {
          ...
          insight: 'Households on TOU plans shift 20–42% of peak demand to off-peak hours, reducing grid strain and lowering bills.',
          source: 'EIA 2024 Retail Sales / utility TOU rate schedules',
          paybackMonths: 0,
        }
      },
      thermostat: () => {
      ...
      nothing: () => ({
        ...
        co2TonsPerYear: 0,
        flags: {},
        insight: '66% of eligible households have not switched to TOU pricing despite potential savings.',
        source: 'EIA Residential Energy Consumption Survey 2023',
        paybackMonths: null,
      }),
      assistance: () => ({
        ...
        co2TonsPerYear: 0,
        flags: { hasCARE: true },
        insight: 'Low-income utility assistance programs provide 25–35% discounts on electricity bills. Millions of qualifying households leave savings unclaimed each year.',
        source: 'LIHEAP / State Low-Income Utility Assistance Programs 2024',
        paybackMonths: 0,
      }),
    },
    ...
    solar: {
      install_now: () => {
        ...
        return {
          ...
          flags: { hasSolar: true },
          insight: 'US solar installations grew 34% YoY in 2023. Average payback: 7–9 years for residential.',
          source: 'EIA Solar Power Operational Data 2024 / federal solar net metering policies',
    ...
    solar_community: {
      subscribe: () => ({
        ...
        insight: 'Renters represent 36% of US households but have historically had limited access to direct solar benefits.',
        source: 'NREL Community Solar Market Report 2024',
        paybackMonths: 3,
      }),
      recruit: () => ({
    ...
    car: {
      ...
      no_car: () => {
        ...
        return {
          ...
          co2TonsPerYear: 3.8,
          flags: { noCar: true },
          insight: 'Transit riders produce 45% less CO₂ per mile than solo car commuters. Expanding public transit use is one of the most impactful ways to cut transportation emissions.',
    ...
    appliance: {
      gas_heater: () => ({
        ...
        insight: 'Gas water heaters emit ~1.1 tons CO₂/year. Several states are phasing out new gas appliance sales as part of clean energy commitments.',
        source: 'EIA RECS 2020 / state clean appliance standards',
        paybackMonths: null,
      }),
      electric_heater: () => ({
